...
include_once $this->targetDirs[5].'/vendor/symfony/http-kernel/CacheWarmer/CacheWarmerAggregate.php';
...
}, 8), true, ($this->targetDirs[0].'/InfrastructureApp_Infrastructure_KernelDevDebugContainerDeprecations.log'));
